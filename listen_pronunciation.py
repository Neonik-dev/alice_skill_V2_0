...
def start():
    return make_response(texts.START_PRONUNCIATIION, state={"pronunciation": "start"},
                         buttons=[button("Начинаем", hide=True)])


def learn_words():
    head = "Выберите правильный перевод"
    return make_response(text=head,
                         tts='<speaker audio="dialogs-upload/4b81da5e-f2e6-4fb2-a5a8-33bc7d7bf7d8/0641af74-0e45-4686-8092-03c7aa53b2bc.opus">',
                         button=button(title="Повторить аудио", hide=False))
